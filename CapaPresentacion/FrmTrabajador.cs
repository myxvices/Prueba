...
namespace CapaPresentacion
{
    public partial class FrmTrabajador : Form
    {
        ...
        public FrmTrabajador()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtApellidos, "Ingrese los Apellidos del Trabajado");
            this.ttMensaje.SetToolTip(this.txtDireccion, "Ingrese la Dirección del Trabajado");
            this.ttMensaje.SetToolTip(this.txtNum_Documento, "Ingrese el número del documento del Trabajado");
            this.ttMensaje.SetToolTip(this.txtUsuario, "Ingrese Usuario del trabajador");
            this.ttMensaje.SetToolTip(this.txtPassword, "Ingrese Password del trabajador");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string rpta = "";
                if (this.txtNombre.Text == string.Empty || this.txtUsuario.Text == string.Empty || this.txtPassword.Text == string.Empty || this.txtApellidos.Text == string.Empty || this.txtNum_Documento.Text == string.Empty || this.txtUsuario.Text == string.Empty)
                {
                    MensajeError("Falta ingresar algunos datos, serán remarcados");
                    errorIcono.SetError(txtNombre, "Ingrese un Nombre");
                    errorIcono.SetError(txtNum_Documento, "Ingrese un Número de Documento");
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NTrabajador.Insertar(this.txtNombre.Text.Trim().ToUpper(),
                                                   ...
                                                   this.txtNum_Documento.Text, this.txtDireccion.Text,
