...
namespace CapaPresentacion
{
    public partial class FrmArticulo : Form
    {
        ...
        public FrmArticulo()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtCategoria, "Ingrese la Categoría del Articulo");
            this.ttMensaje.SetToolTip(this.cbIdpresentacion, "Ingrese la Presentación del Articulo");
