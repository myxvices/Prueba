...
namespace CapaPresentacion
{
    public partial class FrmCliente : Form
    {
        ...
        public FrmCliente()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtNum_Documento, "Ingrese el número del documento del Cliente");
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string rpta = "";
                if (this.txtNombre.Text == string.Empty || this.txtNum_Documento.Text == string.Empty || this.txtDireccion.Text == string.Empty || this.txtApellidos.Text == string.Empty)
                {
                    ...
                    if (this.IsNuevo)
                    {
                        rpta = NCliente.Insertar(this.txtNombre.Text.Trim().ToUpper(),
                                                this.txtApellidos.Text.Trim().ToUpper(),this.cbSexo.Text,
                                                   this.dtFechaNac.Value, this.cbTipo_Documento.Text,
