        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtRazon_Social.Text == string.Empty || this.txtNum_Documento.Text == string.Empty || this.txtDireccion.Text == string.Empty)
                {
                    ...
                    errorIcono.SetError(txtRazon_Social, "Ingrese una Razon Social");
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NProveedor.Insertar(this.txtRazon_Social.Text.Trim().ToUpper(),
                                                   this.cbSector_Comercial.Text, this.cbTipo_Documento.Text,
                                                   this.txtNum_Documento.Text, this.txtDireccion.Text,
                                                   this.txtTelefono.Text,this.txtEmail.Text,txtUrl.Text);
                    }
                    else
                    {
