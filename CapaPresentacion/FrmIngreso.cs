...
namespace CapaPresentacion
{
    public partial class FrmIngreso : Form
    {
        ...
        private void LimpiarDetalle()
        {
            ...
            this.dtFecha_Produccion.Value = DateTime.Now;
        ...
        {
            this.dataListadoDetalle.DataSource = NIngreso.MostrarDetalles(this.txtIdingreso.Text);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtIdarticulo.Text == string.Empty || this.txtStock.Text == string.Empty || this.txtPrecioCompra.Text == string.Empty || this.txtPrecioVenta.Text == string.Empty)
                {
                    ...
                    errorIcono.SetError(txtPrecioCompra, "Ingrese Precio Compra");
